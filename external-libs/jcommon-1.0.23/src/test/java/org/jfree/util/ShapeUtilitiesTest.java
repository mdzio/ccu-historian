 ...
 * Contributor(s):   -;
 *
 * $Id: ShapeUtilitiesTest.java,v 1.9 2008/06/02 06:58:28 mungady Exp $
 *
 * Changes
 * -------
 ...
 */
public class ShapeUtilitiesTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(ShapeUtilitiesTest.class);
    }
     ...
     */
    public ShapeUtilitiesTest(final String name) {
        super(name);
    }
