 ...
 * Contributor(s):   -;
 *
 * $Id: BooleanListTest.java,v 1.3 2007/11/02 17:50:37 taqua Exp $
 *
 * Changes
 * -------
...
public class BooleanListTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(BooleanListTest.class);
    }
     ...
     */
    public BooleanListTest(final String name) {
        super(name);
    }
