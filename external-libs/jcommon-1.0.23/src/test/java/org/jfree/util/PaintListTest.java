 ...
 * Contributor(s):   -;
 *
 * $Id: PaintListTest.java,v 1.5 2011/11/03 20:53:47 mungady Exp $
 *
 * Changes
 * -------
 ...
 */
public class PaintListTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(PaintListTest.class);
    }
     ...
     */
    public PaintListTest(final String name) {
        super(name);
    }
