 ...
 * 
 * ----------------------------------
 * AttributedStringUtilitiesTest.java
 * ----------------------------------
 ...
 * Contributor(s):   -;
 *
 * $Id: AttributedStringUtilitiesTest.java,v 1.3 2007/11/02 17:50:37 taqua Exp $
 *
 * Changes
 * -------
 ...
 */
public class AttributedStringUtilitiesTest  extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(AttributedStringUtilitiesTest.class);
    }
     ...
     */
    public AttributedStringUtilitiesTest(String name) {
        super(name);
    }
