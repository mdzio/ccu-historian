 ...
 * Contributor(s):   -;
 *
 * $Id: TextFragmentTest.java,v 1.5 2007/11/02 17:50:36 taqua Exp $
 *
 * Changes:
 * --------
...
public class TextFragmentTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(TextFragmentTest.class);
    }
     ...
     */
    public TextFragmentTest(final String name) {
        super(name);
    }
