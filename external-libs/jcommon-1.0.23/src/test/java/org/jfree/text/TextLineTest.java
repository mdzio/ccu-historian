 ...
 * Contributor(s):   -;
 *
 * $Id: TextLineTest.java,v 1.5 2007/11/02 17:50:36 taqua Exp $
 *
 * Changes:
 * --------
 ...
 */
public class TextLineTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(TextLineTest.class);
    }
     ...
     */
    public TextLineTest(final String name) {
        super(name);
    }
