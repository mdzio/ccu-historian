 ...
 * Contributor(s):   -;
 *
 * $Id: VerticalAlignmentTest.java,v 1.3 2007/11/02 17:50:37 taqua Exp $
 *
 * Changes
 * -------
...
public class VerticalAlignmentTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(VerticalAlignmentTest.class);
    }
     ...
     */
    public VerticalAlignmentTest(final String name) {
        super(name);
    }
