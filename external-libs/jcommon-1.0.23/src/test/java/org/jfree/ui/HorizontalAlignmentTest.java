 ...
 * Contributor(s):   -;
 *
 * $Id: HorizontalAlignmentTest.java,v 1.3 2007/11/02 17:50:37 taqua Exp $
 *
 * Changes
 * -------
...
public class HorizontalAlignmentTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(HorizontalAlignmentTest.class);
    }
     ...
     */
    public HorizontalAlignmentTest(final String name) {
        super(name);
    }
