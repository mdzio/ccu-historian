 ...
 * 
 * -------------------------------------
 * GradientPaintTransformerTypeTest.java
 * -------------------------------------
 ...
 * Contributor(s):   -;
 *
 * $Id: GradientPaintTransformTypeTest.java,v 1.3 2007/11/02 17:50:37 taqua Exp $
 *
 * Changes
 * -------
 ...
 */
public class GradientPaintTransformTypeTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(GradientPaintTransformTypeTest.class);
    }
     ...
     */
    public GradientPaintTransformTypeTest(final String name) {
        super(name);
    }
