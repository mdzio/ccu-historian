 ...
 * 
 * ------------------------------------------
 * StandardGradientPaintTransformerTest.java
 * ------------------------------------------
 ...
 * Contributor(s):   -;
 *
 * $Id: StandardGradientPaintTransformerTest.java,v 1.5 2007/11/02 17:50:37 taqua Exp $
 *
 * Changes
 * -------
 ...
 */
public class StandardGradientPaintTransformerTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(StandardGradientPaintTransformerTest.class);
    }
     ...
     */
    public StandardGradientPaintTransformerTest(final String name) {
        super(name);
    }
