 ...
 * Contributor(s):   -;
 *
 * $Id: Size2DTest.java,v 1.3 2007/11/02 17:50:37 taqua Exp $
 *
 * Changes
 * -------
 ...
 */
public class Size2DTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(Size2DTest.class);
    }
     ...
     */
    public Size2DTest(final String name) {
        super(name);
    }
