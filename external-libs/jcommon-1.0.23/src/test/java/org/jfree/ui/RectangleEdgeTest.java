 ...
 * Contributor(s):   -;
 *
 * $Id: RectangleEdgeTest.java,v 1.3 2007/11/02 17:50:37 taqua Exp $
 *
 * Changes
 * -------
 ...
 */
public class RectangleEdgeTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(RectangleEdgeTest.class);
    }
     ...
     */
    public RectangleEdgeTest(final String name) {
        super(name);
    }
